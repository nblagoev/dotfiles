...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  group = vim.api.nvim_create_augroup("nbl/lang_version", { clear = true }),
})
...
-- }
local mode_color = {
  ["n"] = { "NO", "%#StatusNormalInv#" },
  ["i"] = { "IN", "%#StatusInsertInv#" },
  ["ic"] = { "IN", "%#StatusInsertInv#" },
  ["v"] = { "VI", "%#StatusVisualInv#" },
  ["V"] = { "VL", "%#StatusVisualInv#" },
  ["Vs"] = { "VL", "%#StatusVisualInv#" },
  ["\22"] = { "VB", "%#StatusVisualInv#" },
  ["\22s"] = { "VB", "%#StatusVisualInv#" },
  ["R"] = { "RE", "%#StatusReplaceInv#" },
  ["c"] = { "CO", "%#StatusCommandInv#" },
  ["t"] = { "TE", "%#StatusCommandInv#" },
  ["nt"] = { "NT", "%#StatusCommandInv#" },
}
...
local function get_theme_color(mode)
  ...
  elseif string.match(vim.g.colors_name, "^(.+)fox$") then
    ...
    return mode == "insert" and palette.orange.base or palette.blue.base
  end
