...
--- Implementation inspired from https://github.com/MariaSolOs/dotfiles/blob/86d131ea95cd4e0c84e285e5f4eb1562ed5d2c61/.config/nvim/lua/lightbulb.lua

local M = {}

local lb_name = 'nbl/lightbulb'
local lb_namespace = vim.api.nvim_create_namespace(lb_name)
local lb_icon = require('icons').ui.Lightbulb
