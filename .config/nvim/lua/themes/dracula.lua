  ...
  config = function()
    ...
    dracula.setup({
      ...
      overrides = {
        ...
        Keyword = { fg = c.pink, italic = false },
        ...
        ["@type.builtin"] = { fg = c.bright_cyan, italic = false },
        ...
        StatusLine = { fg = c.white, bg = "None" },
        StatusLineNC = { fg = c.white, bg = c.bg },
        -- TreesitterContext = { bg = c.bg },
        TreesitterContextBottom = { underline = true, sp = c.purple },
        MiniTablineFill = { bg = c.bg_lighter },
        MiniTablineVisible = { fg = c.bright_magenta, bg = c.bg_lighter },
        MiniTablineHidden = { fg = c.fg_dark, bg = c.bg_lighter },
        MiniTablineModifiedCurrent = { fg = c.red, bg = c.bg },
        MiniTablineModifiedHidden = { fg = c.red, bg = c.bg_lighter },
        MiniTablineModifiedVisible = { fg = c.red, bg = c.bg_lighter },
        SnacksPickerDir = { fg = c.gutter_fg },
        SnacksPickerListCursorLine = { bg = c.bg_lighter },
        WhichKeyNormal = { bg = c.bg_lighter },
