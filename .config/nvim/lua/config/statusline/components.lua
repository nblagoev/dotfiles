...
local mode_color = {
  ["n"] = { "N", "%#StatusNormalInv#" },
  ["i"] = { "I", "%#StatusInsertInv#" },
  ["ic"] = { "I", "%#StatusInsertInv#" },
  ["v"] = { "V", "%#StatusVisualInv#" },
  ["V"] = { "V·L", "%#StatusVisualInv#" },
  ["Vs"] = { "V·L", "%#StatusVisualInv#" },
  ["\22"] = { "V·B", "%#StatusVisualInv#" },
  ["\22s"] = { "V·B", "%#StatusVisualInv#" },
  ["R"] = { "R", "%#StatusReplaceInv#" },
  ["c"] = { "C", "%#StatusCommandInv#" },
  ["t"] = { "T", "%#StatusCommandInv#" },
  ["nt"] = { "N·T", "%#StatusCommandInv#" },
}
